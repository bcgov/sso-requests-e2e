...

{
    ...
    static QuestionRadioButton(value, questiontext) {
        return elm.Locaters.QuestionRadioButton_Xpath1 + questiontext + elm.Locaters.QuestionRadioButton_Xpath2 + value + elm.Locaters.QuestionRadioButton_Xpath3
    }

    static legendQuestionRadioButton(value, legendquestiontext){
        return elm.Locaters.LegendQuestionRadioButton_Xpath1 + legendquestiontext + elm.Locaters.LegendQuestionRadioButton_Xpath2 + value + elm.Locaters.LegendQuestionRadioButton_Xpath3
    }
