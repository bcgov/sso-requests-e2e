...
describe("Verify Team Details", () => {
  ...
  it("Check Team Members", function () {
    ...
    cy.get("div.rc-tabs.rc-tabs-top")
      .eq(1)
      .within(() => {
        cy.get("#rc-tabs-1-tab-members")
          .contains("Members")
          .click({ force: true }); //Members
        cy.contains("td", "pathfinder.ssotraining@gov.bc.ca").should(
          "be.visible"
        );
      });
  });
  ...
  it("Check Team Integrations", function () {
    ...
    cy.get("div.rc-tabs.rc-tabs-top")
      .eq(1)
      .within(() => {
        cy.get("#rc-tabs-1-tab-integrations")
          .contains("Integrations")
          .click({ force: true }); //Integrations
  ...
  it("Check Team Service Accounts", function () {
    ...
    cy.get("div.rc-tabs.rc-tabs-top")
      .eq(1)
      .within(() => {
        cy.get("div#rc-tabs-1-tab-service-accounts")
